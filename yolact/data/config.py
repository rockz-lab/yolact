...
log_detection_dataset = dataset_base.copy({
    'name': 'Log Detection',

    'train_images': './data/logs/img',
    'valid_images': './data/logs/img',
    
    'train_info': './data/logs/img/annotations.json',
    'valid_info': './data/logs/img/annotations.json',

    'class_names': ('stamm'),
    'label_map': {1: 1,}
})

log_det_transfer_dataset = dataset_base.copy({
    'name': 'Log Detection Transfer',

    'train_images': './data/logs/train',
    'valid_images': './data/logs/val',
    
    'train_info': './data/logs/train/annotations.json',
    'valid_info': './data/logs/val/annotations.json',

    #'train_images': '/media/Forwarder/10_Projekte/02_Stammerkennung/Datensatz_2D_merged/backup_images',
    #'valid_images': '/media/Forwarder/10_Projekte/02_Stammerkennung/Datensatz_2D_merged/backup_images',

    #'train_info': '/media/Forwarder/10_Projekte/02_Stammerkennung/Datensatz_2D_merged/backup_images/annotations.json',
    #'valid_info': '/media/Forwarder/10_Projekte/02_Stammerkennung/Datensatz_2D_merged/backup_images/annotations.json',

    'class_names': ('log', 'log gripped', 'tree', 'stem cut off'),
...
logs_resnet50_config = yolact_base_config.copy({
    'name': 'logs_resnet50',

    'dataset': log_detection_dataset,
    'num_classes': len(log_detection_dataset.class_names) +1 ,
...
logs_plus_base_config = yolact_plus_base_config.copy({
    'name': 'logs_plus_base',

    'dataset': log_det_transfer_dataset,
    'num_classes': len(log_det_transfer_dataset.class_names) + 1,
